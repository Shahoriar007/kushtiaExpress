                                ...
                                @foreach ($detail->photos as $photo)
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link {{ $loop->index == 0 ? 'active' : '' }}"
                                            id="thumb{{ $loop->index + 1 }}-tab" data-bs-toggle="tab"
                                            data-bs-target="#thumb{{ $loop->index + 1 }}" type="button" role="tab"
                                            aria-controls="thumb{{ $loop->index + 1 }}" aria-selected="true">
                                ...
                                <div class="tab-content" id="productThumbContent">
                                    ...
                                    @foreach ($detail->photos as $photo)
                                        <div class="tab-pane fade {{ $loop->index == 0 ? 'show active' : '' }}"
                                            id="thumb{{ $loop->index + 1 }}" role="tabpanel"
                                            aria-labelledby="thumb{{ $loop->index + 1 }}-tab">
                    ...
                    <div class="col-xl-6">
                        <div class="product__details-content">
                            ...
                            <div class="price mb-10">
                                @if ($detail->offer_price)
                                    <span style="text-decoration: line-through;"> ৳ {{ $detail->price }}</span>
                                    <span> ৳ {{ $detail->offer_price }}</span>
                                @else
                            ...
                            @if ($detail->link)
                                <div class="cart-option mb-15">
                                    ...
                                    <a href="{{ $detail->link }}" class="cart-btn-youtube "><i class="fab fa-youtube"></i>
                                        Watch on Youtube</a>
                            ...
                            <div class="cart-option mb-15">
                                ...
                                <a href="https://wa.me/+8801911550555" class="cart-btn "><i class="fab fa-whatsapp"></i>
